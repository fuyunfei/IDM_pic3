function [siftImage,gridX, gridY] = iat_rgbd_sift(im,depth, patch_size, grid_spacing, varargin)
...
% which results from IMAGE's grid sampled with GRIDSPACING factor (and
% after ignoring PS/2 rows and columns from all image borders).
%
% Input arguments:
