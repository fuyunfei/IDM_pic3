...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if(nrhs>=3)
    {
        ...
        printf("nrhs=%d nDims=%d dims[0]=%d dims[1]=%d ",nrhs,nDims,dims[0],dims[1]);
...
//	bpflow.LoadImages(Im1.width(),Im1.height(),Im1.nchannels(),Im1.data(),Im2.width(),Im2.height(),Im2.data());
	bpflow.LoadImages(Im1.width(),Im1.height(),Im1.nchannels(),Im1.data(),Im2.data(),D_Im1.data(),D_Im2.data());
