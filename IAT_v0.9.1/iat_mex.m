...
mexDir = [rootDir filesep 'mex' filesep computer('arch') ];
...
command = ['mex -g ' rootDir filesep 'mex' filesep 'iat_match_features_mex.cpp -outdir ' mexDir];
eval(command);
fprintf('DONE\n');

% SIFTflow
fprintf('Compiling SIFTflow.cpp......\n');
SFp = [rootDir filesep 'nonrigid' filesep 'siftflow' filesep cppfilename filesep]; 
command = ['mex -g ' SFp 'SIFTflow.cpp ' SFp 'BPFlow.cpp ' SFp 'Stochastic.cpp -outdir ' mexDir ' -output iat_SIFTflow_mex'];
eval(command);
fprintf('DONE\n');
